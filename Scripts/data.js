                ...
                for (let i = 0; i < sortedList.length; i++) {
                    ...
                    if (globals.pltAppMode == "AppOwnsData") {
                        ...
                        <td class="report_link">
                            <a target="blank" href='/AppOwnsPLT/AppOwnsURLEmbedReport?workspace=${sortedList[i].datasetWorkspaceId}&report=${sortedList[i].id}'><img class="plt_file_svg" src="../../Content/img/Report Link.svg" width="30" height="30" /></a>
                        </td>

                        <td class="load_count">
                            <div class="count_error">Maximum LT count is 35</div>
                            <div class="count_error">Minimum LT count is 1</div>
                            <input class="ibox input_box_style" type="number" value="1" />                           
                        </td>
